...
% gaussian with exponential decay series
...
% typically 0.05-0.03.
% td: array, the exponential decay time, in unit of DA sampling interval,
...
% figure();plot(IMPR_f, real(IMPR_fa),'+');hold on;plot(IMPR_f, imag(IMPR_fa),'+');
