...
ramsey('qubit','q8','mode','dp',... % available modes are: df01, dp and dz
      'time',[0:50:1e3],'detuning',[0]*1e6,...
      'dataTyp','Phase','phaseOffset',0,'notes','','gui',true,'save',true); % P or Phase
%%
ramsey_dz('qubit','q8',...
...
%%
setQSettings('r_avg',3000);
T1_1('qubit','q1','biasAmp',[0],'biasDelay',20,'time',[20:500:2.8e4],... % [20:200:2.8e4]
      'gui',true,'save',true);
%%
