...
% Yulin Wu, 2017/3/11
rabi_amp1('qubit','q5','biasAmp',[0],'biasLonger',20,...
      'xyDriveAmp',[0e4:500:3e4],'detuning',[0],'driveTyp','X/2',...
...
T1_1('qubit','q6','biasAmp',[-15000:300:-11000],'biasDelay',20,'time',[20:1000:2.8e4],... % [20:200:2.8e4]
      'gui',true,'save',true);
%%
