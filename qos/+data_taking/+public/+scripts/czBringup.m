...
czAmp=linspace(2.37e4,2.41e4,30); 
setQSettings('r_avg',2000);
acz1=acz_ampLength('controlQ','q7','targetQ','q6',...
       'dataTyp','Phase',...
       'czLength',czLength,'czAmp',czAmp,'cState','1',...
       'notes','','gui',true,'save',true);
acz0=acz_ampLength('controlQ','q7','targetQ','q6',...
       'dataTyp','Phase',...
...
%% Tomography
setQSettings('r_avg',2500);
CZTomoData = Tomo_2QProcess('qubit1','q3','qubit2','q2',...
       'process','CZ',...
       'notes','','gui',true,'save',true);
