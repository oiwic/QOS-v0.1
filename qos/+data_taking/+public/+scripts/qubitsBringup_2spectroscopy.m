...
freq = f01-1e6:0.05e6:f01+1e6;
%freq = 4.2585e9:0.05e6:4.2605e9;
spectroscopy1_zdc('qubit',q,'biasAmp',[-5.2e3:100:-4.4e3],'driveFreq',[freq],...
...
%%
setQSettings('r_avg',700);
spectroscopy1_zpa_auto('qubit','q3','biasAmp',-3e3:1000:3e4,...
