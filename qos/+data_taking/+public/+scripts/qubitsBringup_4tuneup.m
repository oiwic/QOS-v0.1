...
acz_ampLength('controlQ','q7','targetQ','q8',...
       'dataTyp','Phase',...
       'czLength',[200],'czAmp',[2.75e4:10:2.80e4],'cState','1',...
       'notes','','gui',true,'save',true);
%%
tuneup.APE('qubit','q8',...
...
'gui',true,'save',true);
%%
zDelay('zQubit','q9','xyQubit','q9','zAmp',3e4,'zLn',[],'zDelay',[-50:1:50],...
       'gui',true,'save',true);
%%
...
temp.czRBFidelityVsPhase('controlQ','q7','targetQ','q8',...
      'phase_c',[2.12:2*pi/250:2.16],'phase_t',[-1.025:2*pi/250:-0.9],...
