...
%     tuneup.xyGateAmpTuner_parallel('qubits',qs,'gateTyp','X/2',...
%         'AENumPi',AENumPi,'tuneRange',gAmpTuneRange,'gui',gui,'save',true,'logger',logger);
...
%% cz
czQSets = {{{'q1','q2'};{'q1','q3','q5','q11'};{'q2','q4','q6','q10'}},...
           {{'q3','q2'};{'q1','q3','q5','q11'};{'q2','q4','q6','q10'}},...
           {{'q3','q4'};{'q1','q3','q5','q11'};{'q2','q4','q6','q10'}},...
           {{'q5','q4'};{'q1','q3','q5','q11'};{'q2','q4','q6','q10'}},...
           {{'q5','q6'};{'q1','q3','q5','q11'};{'q2','q4','q6','q10'}},...
           {{'q7','q6'};{'q1','q3','q5','q7','q11'};{'q2','q4','q6','q10'}},...
           {{'q9','q10'};{'q1','q3','q5','q9','q11'};{'q2','q4','q6','q10'}},...
           {{'q11','q10'};{'q1','q3','q5','q11'};{'q2','q4','q6','q10'}},...
          };
