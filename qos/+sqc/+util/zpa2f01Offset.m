function offset = zpa2f01Offset(q)
% the zpls_amp2f01 in the registry is correct up to a x offset, this
% function calculates this offset
% assumes zplsamp2f01 x offset is not large 
...
%                 q.name, q.f01/1e9));
    ...
    ar = abs(r);
    % assume zplsamp2f01 x offset is not large
